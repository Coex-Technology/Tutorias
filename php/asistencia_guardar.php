    ...
    if($verificacion >= 0) {
        ...
        if (!isset($_SESSION['formulario_enviado'])) {
            ...
            foreach ($inasistencias_justificadas as $estudiante_ci => $falta) {
                ...
                $guardar_asistencia = $guardar_asistencia->prepare("INSERT INTO asistencias(tutorias_id,estudiantes_ci,docente_ci,fecha,fecha_ingreso,inasistencias_justificadas) VALUES (:tutorias_id,:estudiantes_ci,:docente_ci,:fecha,:fecha_ingreso,:inasistencias_justificadas)");
                $guardar_asistencia->execute($marcadores_asistencia);
            }
            ...
            foreach ($inasistencias_injustificadas as $estudiante_ci => $falta) {
                ...
                $guardar_asistencia = $guardar_asistencia->prepare("INSERT INTO asistencias(tutorias_id,estudiantes_ci,docente_ci,fecha,fecha_ingreso,inasistencias_injustificadas) VALUES (:tutorias_id,:estudiantes_ci,:docente_ci,:fecha,:fecha_ingreso,:inasistencias_injustificadas)");
                $guardar_asistencia->execute($marcadores_asistencia);
            }
            ...
            if ($guardar_asistencia !== null && $guardar_asistencia->rowCount() == 1) {
                echo '
                    <div class="notification is-info is-light">
                        ...
                        La asistencia se actualizo con éxito,
                        <a href="index.php?vista=consult_attendance&id='.$tutorias_id.'"> puede consultarla aquí </a>
                    </div>
                ';
            } else {
