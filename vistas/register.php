    ...
    <form action="./php/usuario_guardar.php" method="POST" class="FormularioAjax" autocomplete="off">
        ...
        <div class="borde_registro">
            ...
            <div>
                <div class="control">
                    <label> <b class="asterisco"></b> </label>
                    <input type="hidden" name="tipo" value = "<?php echo htmlspecialchars($usuario_tipo); ?>">
                </div>
            </div>  
                    ...
                    <div class="column is-full-desktop">
                        <div class="section register_guardar">
                            <div class="has-text-centered">
                                <button class="container button is-info is-rounded pt-5 pr-5 pb-5 pl-5 margen_register">
