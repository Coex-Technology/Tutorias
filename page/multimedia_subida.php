                    ...
                    $tabla.='</p>
                            ...
                            <div class="media-content">
                                ...
                                <div class="has-text-right">
                                    <a href="index.php?vista=ver_archivo&archivo='.$rows['archivo_id'].'&id='.$rows['tutorias_id'].'&ci='.$rows['usuarios_ci'].'" class="button is-success is-rounded is-small">Archivo</a>';
